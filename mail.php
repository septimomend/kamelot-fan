...
if (isset ($name))
{
$name = substr($name,0,35); //Не может быть более 20 символов
if (empty($name))
{
...
if (isset ($email))
{
$email = substr($email,0,35); //Не может быть более 35 символов
if (empty($email))
{
...
$to = "eldaro103@gmail.com";  /*МЕНЯЕШЬ НА СВОЙ АДРЕСС!*/
